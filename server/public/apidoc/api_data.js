define({ "api": [
  ...
  },
  {
    ...
    "name": "UserInfos",
    "group": "Users",
    "description": "<p>Check, given <code>token</code> in DB.</p>",
    "permission": [
      {
        "name": "true"
      }
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>User <code>token</code> is requried</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "NotFoundError",
            "description": "<p><code>token</code> not found value : <code>XXX--JWT--XXX</code></p>"
          }
        ]
      },
      "examples": [
